...
async def start_command(client: Client, message: Message):
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/+abaqQpyE5SU1MzY1")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/Peldiya")
    repo69 = InlineKeyboardButton("ʀᴇᴘᴏ 🌐", url="https://t.me/+mAgf1IcMqgYwY2I1")
